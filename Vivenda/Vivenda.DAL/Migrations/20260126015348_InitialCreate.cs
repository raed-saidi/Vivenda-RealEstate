        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SquareFeet = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderEmail = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    SenderPhone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "fa-swimming-pool", true, "Swimming Pool" },
                    { 2, "fa-car", true, "Garage" },
                    { 3, "fa-tree", true, "Garden" },
                    { 4, "fa-snowflake", true, "Air Conditioning" },
                    { 5, "fa-fire", true, "Heating" },
                    { 6, "fa-shield-alt", true, "Security System" },
                    { 7, "fa-dumbbell", true, "Gym" },
                    { 8, "fa-elevator", true, "Elevator" },
                    { 9, "fa-door-open", true, "Balcony" },
                    { 10, "fa-fire-alt", true, "Fireplace" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 26, 1, 53, 47, 629, DateTimeKind.Utc).AddTicks(7663), "Residential properties including houses and apartments", "fa-home", true, "Residential" },
                    { 2, new DateTime(2026, 1, 26, 1, 53, 47, 629, DateTimeKind.Utc).AddTicks(7668), "Commercial properties for business use", "fa-building", true, "Commercial" },
                    { 3, new DateTime(2026, 1, 26, 1, 53, 47, 629, DateTimeKind.Utc).AddTicks(7670), "Industrial properties and warehouses", "fa-industry", true, "Industrial" },
                    { 4, new DateTime(2026, 1, 26, 1, 53, 47, 629, DateTimeKind.Utc).AddTicks(7672), "Vacant land and plots", "fa-map", true, "Land" }
                });
